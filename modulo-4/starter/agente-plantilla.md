...
# Armador de contenido de mi sitio
...
1. Lee todos los archivos de memoria listados arriba.
2. Organiza el contenido en secciones claras: Sobre mí, Proyectos, Experiencia, Habilidades, Contacto.
3. Si falta una sección o hay huecos, anótalo al final bajo "Pendientes" en vez de inventar contenido.
4. Guarda el resultado en `mi-trabajo/paquete-de-contenido.md`.
5. Devuelve un resumen breve de lo que armó y qué quedó pendiente.
