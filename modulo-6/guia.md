...
1. Recapitula los seis módulos en pocas líneas: fundamentos → instrucciones → habilidades → agentes y la ventana de contexto → orquestación (equipo en paralelo + corrector universal) → un sitio real, en internet, hecho por ti.
